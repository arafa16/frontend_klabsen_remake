                ...
                <div className="flex justify-between px-20 pt-20">
                    ...
                    <div className="grid grid-cols-1 gap-2 text-xs">
                        ...
                        <div className="mt-1 grid grid-cols-2 gap-4">
                            ...
                            <div>: {data && data.pendapatan_atas}</div>
                        </div>
                    </div>
                </div>
                    ...
                    <Table.Tbody>
                        ...
                        <Table.Td className="border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.basic_salary)}</div>
                            </div>
                        </Table.Td>
                        <Table.Td className=" border-b dark:border-darkmode-400 w-1/6">
                            Zakat
                        ...
                        <Table.Td className="text-right border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.tunjangan_jabatan)}</div>
                            </div>
                        </Table.Td>
                        <Table.Td className=" border-b dark:border-darkmode-400 w-1/6">
                            Iuran Koperasi
                        ...
                        <Table.Td className="text-right border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.iuran_koperasi)}</div>
                            </div>
                        </Table.Td>
                        </Table.Tr>
                        <Table.Tr>
                        ...
                        <Table.Td className="text-right border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.potongan_pinjaman)}</div>
                            </div>
                        </Table.Td>
                        </Table.Tr>
                        <Table.Tr>
                        ...
                        <Table.Td className="text-right border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.potongan_jht)}</div>
                            </div>
                        </Table.Td>
                        </Table.Tr>
                        <Table.Tr>
                        ...
                        <Table.Td className="text-right border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.potongan_bpjs)}</div>
                            </div>
                        </Table.Td>
                        </Table.Tr>
                        <Table.Tr>
                        ...
                        <Table.Td className="text-right border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.potongan_pensiun)}</div>
                            </div>
                        </Table.Td>
                        </Table.Tr>
                        <Table.Tr>
                        ...
                        <Table.Td className="text-right border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.overtime_allowance)}</div>
                            </div>
                        </Table.Td>
                        <Table.Td className=" border-b dark:border-darkmode-400 w-1/6">
                            Adjustment Minus
                        ...
                        <Table.Td className="text-right border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.adjustment_minus)}</div>
                            </div>
                        </Table.Td>
                        </Table.Tr>
                        <Table.Tr>
                        ...
                        <Table.Td className="text-right border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.tunjangan_jht)}</div>
                            </div>
                        </Table.Td>
                        <Table.Td className=" border-b dark:border-darkmode-400 w-1/6">
                            Potongan OR
                        ...
                        <Table.Td className="text-right border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.potongan_pph21)}</div>
                            </div>
                        </Table.Td>
                        </Table.Tr>
                        <Table.Tr>
                        ...
                        <Table.Td className="text-right border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.tunjangan_pensiun)}</div>
                            </div>
                        </Table.Td>
                        <Table.Td className=" border-b dark:border-darkmode-400 w-1/6">
                            Tunjangan JHT
                        ...
                        <Table.Td className="text-right border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.tunjangan_jkk)}</div>
                            </div>
                        </Table.Td>
                        <Table.Td className=" border-b dark:border-darkmode-400 w-1/6">
                            Tunjangan Pensiun
                        ...
                        <Table.Td className="text-right border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.tunjangan_jkm)}</div>
                            </div>
                        </Table.Td>
                        <Table.Td className=" border-b dark:border-darkmode-400 w-1/6">
                            Tunjangan JKK
                        ...
                        <Table.Td className="text-right border-b dark:border-darkmode-400 w-1/6">
                            <div className='flex justify-between'>
                                <div>Rp.</div>
                                <div>{rupiah(data && data.tunjangan_bpjs)}</div>
                            </div>
                        </Table.Td>
                        <Table.Td className=" border-b dark:border-darkmode-400 w-1/6">
                            Tunjangan JKM
