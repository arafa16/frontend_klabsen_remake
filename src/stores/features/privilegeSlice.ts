...
export const createPrivileges: any = createAsyncThunk(
  "createPrivileges",
  async (datas: any, thunkAPI) => {
    try {
      const response = await axios.post(
        import.meta.env.VITE_REACT_APP_API_URL + `/privilege/data`,
        {
          ...
          on_site_modal: datas.on_site_modal,
...
export const updatePrivileges: any = createAsyncThunk(
  "updatePrivileges",
  async (datas: any, thunkAPI) => {
    try {
...
export const updatePrivilegeArray: any = createAsyncThunk(
  "updatePrivilegeArray",
  async (datas: any, thunkAPI) => {
    try {
      const response = await axios.patch(
        import.meta.env.VITE_REACT_APP_API_URL + `/privilege/datas`,
        datas,
        {
          withCredentials: true, // Now this is was the missing piece in the client side
        },
...
export const deletePrivilege: any = createAsyncThunk(
  "deletePrivilege",
  async (datas: any, thunkAPI) => {
    try {
