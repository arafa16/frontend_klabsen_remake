...
export const getInOutsById: any = createAsyncThunk(
  "inOut2/getInOutsById",
  async (datas: any, thunkAPI) => {
    try {
      const response = await axios.get(
        import.meta.env.VITE_REACT_APP_API_URL + `/in_out/data/${datas.uuid}`,
        {
...
export const createInOuts: any = createAsyncThunk(
  "creatInOuts",
  async (datas: any, thunkAPI) => {
    try {
      const response = await axios.post(
        import.meta.env.VITE_REACT_APP_API_URL + `/in_out/data`,
        {
...
export const updateInOuts: any = createAsyncThunk(
  "updateInOuts",
  async (datas: any, thunkAPI) => {
    try {
...
export const deleteInOuts: any = createAsyncThunk(
  "deleteInOuts",
  async (datas: any, thunkAPI) => {
    try {
