...
export const SendEmailForgot : any = createAsyncThunk("forgot/SendEmailForgot", async(datas : any, thunkAPI) => {
    try {
...
export const VerifyToken : any = createAsyncThunk("forgot/VerifyToken", async(datas : any, thunkAPI) => {
    try {
