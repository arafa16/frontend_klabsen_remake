...
function Main() {
  ...
  return (
    <>
      ...
      <div
        className="fixed bottom-0 right-0 z-50 flex items-center justify-center w-40 h-8 mb-10 mr-10 border rounded-full shadow-md cursor-pointer box"
        onClick={switchMode}
      >
        <div className="mr-4 text-slate-600 dark:text-slate-200 text-xs">Dark Mode</div>
        <div
          className={clsx([
