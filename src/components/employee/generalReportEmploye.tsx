          ...
          <div className="grid grid-cols-12 gap-0 py-0 divide-x divide-y box xl:py-5 xl:divide-y-0 divide-dashed divide-slate-200 dark:divide-white/5 ">
              ...
              >
                <div className="flex">
                  <div className="flex items-center justify-center border rounded-full w-[2.2rem] h-[2.2rem] text-warning bg-warning/20 border-warning/20">
                    <Lucide className="w-[1.3rem] h-[1.3rem]" icon="Layers" />
                  </div>
                ...
                <div className="mt-6 text-md text-warning font-medium leading-7">
                  Pendaftar
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <div className="mt-6 text-md text-success font-medium leading-7">
                  Active
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <div className="mt-6 text-md text-danger font-medium leading-7">
                  Non Active
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <div className="mt-6 text-md text-primary font-medium leading-7">
                  All
                </div>
              </div>
            </div>
